...
void printToken(TokenType token, const char *tokenString) {
    ...
    case ADD_ASSIGN: fprintf(listing, "+=\n"); break;
    ...
    case CONCAT: fprintf(listing, "&\n"); break;
    case REGOR: fprintf(listing, "|\n"); break;
    case CLOSURE: fprintf(listing, "#\n"); break;
    case OPTIONAL: fprintf(listing, "?\n"); break;
    ...
    while (tree != NULL) {
        ...
        if (tree->nodekind == StmtK) {
            ...
            case AssignK:
                ...
                break;
            case Add_AssignK:
                fprintf(listing, "Add_Assign to: %s\n", tree->attr.name);
                break;
            case Reg_AssignK:
                fprintf(listing, "Reg_Assign to: %s\n", tree->attr.name);
                break;
            case ReadK:
